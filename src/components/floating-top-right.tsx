    ...
    <>
      ...
      <div className="fixed top-4 left-4 z-[100] flex items-center">
        <div className="relative">
          ...
          {showUnderDev && (
            <div className="absolute top-full left-0 mt-2 w-40 p-3 bg-foreground text-background text-sm font-bold rounded-xl shadow-xl text-center animate-in fade-in slide-in-from-top-2">
              تحت التطوير 🚧
              <button 
                onClick={(e) => {
                  e.stopPropagation()
